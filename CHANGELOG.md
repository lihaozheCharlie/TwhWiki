...
- Evidence-layer and synthesis-layer Wiki architecture.
- Modular build, query, reasoning, and quality Skills.
- Two fictional diary entries and a linked sample Wiki.
- Deterministic checks for tags, WikiLink integrity, Skill routing, and privacy.
- Chinese-first README, architecture, customization, and privacy documentation.
